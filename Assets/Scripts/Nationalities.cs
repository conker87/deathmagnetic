...
public class Nationality {
	...
	public Nationality(string countryCode, string countryName, string demonym, string currencyName, string currencyStringPrefix, string currencyStringSuffix, float currencyMultiplier) {
	...
	public Nationality(string countryCode, string countryName, string nationality, string currencyName,  string currencyStringPrefix, string currencyStringSuffix,  float currencyMultiplier, float costOfLivingMultiplier) {
